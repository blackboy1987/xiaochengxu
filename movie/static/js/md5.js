...
!function() {
    ...
    Md5.prototype.update = function(t) {
        if (!this.finalized) {
            ...
            for (var o, i, s = 0, h = t.length, f = this.blocks, n = this.buffer8; s < h; ) {
                if (this.hashed && (this.hashed = !1, f[0] = f[16], f[16] = f[1] = f[2] = f[3] = f[4] = f[5] = f[6] = f[7] = f[8] = f[9] = f[10] = f[11] = f[12] = f[13] = f[14] = f[15] = 0), 
                e) if (ARRAY_BUFFER) for (i = this.start; s < h && i < 64; ++s) n[i++] = t[s]; else for (i = this.start; s < h && i < 64; ++s) f[i >> 2] |= t[s] << SHIFT[3 & i++]; else if (ARRAY_BUFFER) for (i = this.start; s < h && i < 64; ++s) (o = t.charCodeAt(s)) < 128 ? n[i++] = o : o < 2048 ? (n[i++] = 192 | o >> 6, 
                n[i++] = 128 | 63 & o) : o < 55296 || o >= 57344 ? (n[i++] = 224 | o >> 12, n[i++] = 128 | o >> 6 & 63, 
                n[i++] = 128 | 63 & o) : (o = 65536 + ((1023 & o) << 10 | 1023 & t.charCodeAt(++s)), 
                n[i++] = 240 | o >> 18, n[i++] = 128 | o >> 12 & 63, n[i++] = 128 | o >> 6 & 63, 
                n[i++] = 128 | 63 & o); else for (i = this.start; s < h && i < 64; ++s) (o = t.charCodeAt(s)) < 128 ? f[i >> 2] |= o << SHIFT[3 & i++] : o < 2048 ? (f[i >> 2] |= (192 | o >> 6) << SHIFT[3 & i++], 
                f[i >> 2] |= (128 | 63 & o) << SHIFT[3 & i++]) : o < 55296 || o >= 57344 ? (f[i >> 2] |= (224 | o >> 12) << SHIFT[3 & i++], 
