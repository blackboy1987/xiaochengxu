...
function getSign(e, t, n) {
    ...
    f < i.length - 1 && (c += "&"));
    var g = getApp();
    return null == g && ((g = {}).siteInfo = require("../../../siteinfo.js")), o = r(c + (n = n || g.siteInfo.token));
}
...
util.base64_encode = function(e) {
    ...
    var n = getApp();
    null == n && ((n = {}).siteInfo = require("../../../siteinfo.js"));
    var a = n.siteInfo.siteroot + "?i=" + n.siteInfo.uniacid + "&t=" + n.siteInfo.multiid + "&v=" + n.siteInfo.version + "&from=wxapp&";
...
}, util.host_url = function() {
    var e = require("../../../siteinfo.js").siteroot.split("/");
    return e[0] + "//" + e[2];
}, util.request_url = function(e) {
    ...
    var a = getSign(n += "m=aaa_zhaocha", e.data);
    return a && (n = n + "&sign=" + a), n;
    ...
    !a.data || !a.data.m) {
        ...
        o.length && (o = o[getCurrentPages().length - 1]) && o.__route__ && (i += "m=aaa_zhaocha");
    }
