                  ...
                  </View>
                  {
                      status==='empty' ? (
                          <>
                              ...
                              <View className="desc">每次答题需消耗
                                  <Text className="hl">1张答题卡</Text>
                              </View>
                              <Button className="free-btn">免费领取答题卡</Button>
                          </>
                      ) : null
                  }
                  {
                      status==='right' ? (
                          <>
                              ...
                              <Button className="free-btn">继续答题赚红包</Button>
                          </>
                      ) : null
                  }
                  {
                  ...
                  }
                  {
                      status==='cashout' ? (
                          <>
                              ...
                              <Button bindtap="hideOtherModal" className="free-btn">继续答题赚红包</Button>
                          </>
                      ) : null
                  }
                  {
                  ...
                  }
                  {
                      status==='get' ? (
                          <>
                              ...
                              <View className="desc hl">试玩
                                  <Text className="hl">20秒</Text>以上才能获得答题卡
                              </View>
                              <Button className="free-btn">继续试玩小程序</Button>
                          </>
                      ) : null
                  }
              </View>
